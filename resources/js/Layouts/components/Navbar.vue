...
<template>
        <!-- Menu lateral -->
        <div class="px-4 py-2 bg-blue-600 lg:w-1/4 lg:h-full">
            ...
            <div class="hidden lg:block">
                ...
                <ul>
                    <li class="mb-6">
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-2 pt-5">
                        ...
                        <input type="search" name="search" class="w-full px-4 py-2 pl-12 rounded shadow outline-none"
                            placeholder="Search...">
                    </li>
                    <li class="mb-1 bg-gray-800 rounded shadow">
                    ...
                    <li class=" mb-1 rounded hover:shadow hover:bg-gray-800">
                        <a href="#" class="inline-block w-full h-full px-3 py-2 font-bold text-white">
